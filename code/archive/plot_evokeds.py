    ...
    for fname in fnames:
        ...
        #==============================================================================
                ...
                if remove_ECG_artifacts == True:
                    t = ''
                    exclude_inds.extend(ica.labels_[u'ecg'])
                    
                if number_of_eog_components_to_remove:
                    s = '_{}EOGcomp'.format(number_of_eog_components_to_remove)
                    exclude_inds.extend(ica.labels_[u'eog'][:number_of_eog_components_to_remove])
                else:
                    s = '_{}EOGcomp'.format(len(ica.labels_[u'eog']))
                    exclude_inds.extend(ica.labels_[u'eog'])
